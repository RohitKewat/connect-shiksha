...
const title = "About Connect Shiksha";
const desc =
...
const tweetList = [
  {
    ...
    desc: (
      <p>
        Aminur islam <a href="#">@CodexCoder Connect Shiksha #HTML_Template</a>{" "}
  ...
  },
  {
    ...
    desc: (
      <p>
        Somrat islam <a href="#">@CodexCoder Connect Shiksha #HTML_Template</a>{" "}
        Grab your item, 50% Big Sale Offer !!
      </p>
    ),
  },
      ...
      <div className="footer-bottom">
        <div className="container">
          <div className="section-wrapper">
            <p>
              &copy; 2022 <Link to="/">Connect Shiksha</Link> Designed by{" "}
